...
COIN_TGZ='https://github.com/fivebalanceID/Fivebalance_V3/releases/download/v3.2.0/fivebalance-3.2.0-ubuntu18.0.4.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='fivebalanced'
COIN_EXPLORER='http://insight.fivebalance.id'
COIN_PORT=5555
RPC_PORT=5551
